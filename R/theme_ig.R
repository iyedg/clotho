...
#' @param plot_margin plot margin (specify with `margin()`)
...
#' }
theme_ig <- function(base_family = "Merriweather", base_size = type_base_size,
                     plot_title_family = "Fira Sans", plot_title_size = type_scale$title_size,
                     plot_title_face = "bold", plot_title_margin = 10,
                     subtitle_family = base_family, subtitle_size = type_scale$subtitle_size,
                     subtitle_face = "plain", subtitle_margin = 15,
                     strip_text_family = base_family, strip_text_size = type_base_size,
                     strip_text_face = "plain",
                     caption_family = base_family, caption_size = type_base_size,
                     caption_face = "italic", caption_margin = 10,
                     axis_text_size = base_size,
                     axis_title_family = subtitle_family, axis_title_size = type_base_size,
...
#'
#' Updates [geom_label] and [geom_text] font defaults
#'
#' @param family,face,size,color font family name, face, size and color
#' @export
update_geom_font_defaults <- function(family = "Fira Sans", face = "plain", size = 3.5,
                                      color = "#2b2b2b") {
...
type_scale_ratio <- 1.125
type_base_size <- 11

type_scale <- list(
  subtitle_size = type_base_size * type_scale_ratio^2,
  title_size = type_base_size * type_scale_ratio^4
)
